...
# Setup help
setup_help "Scan project for security vulnerabilities, hardcoded secrets, and insecure configurations"
add_help_option "--fix    Attempt to auto-fix issues where possible (future)"
handle_help "$@"
